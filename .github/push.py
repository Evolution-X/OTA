...
cnb_webhook = os.environ["CNB_WEBHOOK"]
...
cnb_vanilla_webhook = os.environ["CNB_VANILLA_WEBHOOK"]
...
def webhook_send():
    ...
    # Discord Hook
    if "Vanilla" in filename and "12." in version:
        webhook_url = cnb_vanilla_webhook
    ...
    if "Vanilla" not in filename and "12." in version:
        webhook_url = cnb_webhook
